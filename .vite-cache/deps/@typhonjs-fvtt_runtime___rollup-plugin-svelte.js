...
var require_require_relative = __commonJS({
  "node_modules/require-relative/index.js"(exports, module) {
    "use strict";
    var path = require_path();
    var Module = require_module();
    var modules = {};
    var getModule = function(dir2) {
      var rootPath = dir2 ? path.resolve(dir2) : process.cwd();
...
function get_attribute_value(attribute) {
  ...
  return attribute.chunks.map((chunk) => {
    return chunk.type === "Text" ? string_literal(chunk.data.replace(/"/g, "&quot;")) : x`@escape(${chunk.node}, true)`;
  }).reduce((lhs, rhs) => x`${lhs} + ${rhs}`);
}
...
function perform_replacements(replacements, source) {
  ...
  for (const { offset: offset2, length: length2, replacement } of replacements) {
    const unchanged_prefix = MappedCode.from_source(slice_source(source.source.slice(last_end, offset2), last_end, source));
...
function parse_tag_attributes(str) {
  return str.split(/\s+/).filter(Boolean).reduce((attrs, attr) => {
    ...
    const [key, value2] = i > 0 ? [attr.slice(0, i), attr.slice(i + 1)] : [attr];
    const [, unquoted] = value2 && value2.match(/^['"](.*)['"]$/) || [];
    return Object.assign(Object.assign({}, attrs), { [key]: (_a = unquoted !== null && unquoted !== void 0 ? unquoted : value2) !== null && _a !== void 0 ? _a : true });
  }, {});
}
...
async function preprocess(source, preprocessor, options) {
  ...
  for (const process2 of markup) {
    result.update_source(await process_markup(process2, result));
  }
...
var now, Stats, astralIdentifierCodes, astralIdentifierStartCodes, nonASCIIidentifierChars, nonASCIIidentifierStartChars, reservedWords, ecma5AndLessKeywords, keywords$1, keywordRelationalOperator, nonASCIIidentifierStart, nonASCIIidentifier, TokenType, beforeExpr, startsExpr, keywords, types$1, lineBreak, lineBreakG, nonASCIIwhitespace, skipWhiteSpace, ref, hasOwnProperty, toString, hasOwn, isArray, loneSurrogate, Position, SourceLocation, defaultOptions, warnedAboutEcmaVersion, SCOPE_TOP, SCOPE_FUNCTION, SCOPE_ASYNC, SCOPE_GENERATOR, SCOPE_ARROW, SCOPE_SIMPLE_CATCH, SCOPE_SUPER, SCOPE_DIRECT_SUPER, SCOPE_CLASS_STATIC_BLOCK, SCOPE_VAR, BIND_NONE, BIND_VAR, BIND_LEXICAL, BIND_FUNCTION, BIND_SIMPLE_CATCH, BIND_OUTSIDE, Parser, prototypeAccessors, pp$9, literal, DestructuringErrors, pp$8, loopLabel, switchLabel, empty$1, FUNC_STATEMENT, FUNC_HANGING_STATEMENT, FUNC_NULLABLE_ID, pp$7, TokContext, types, pp$6, pp$5, empty, pp$4, pp$3, Scope, Node, pp$2, ecma9BinaryProperties, ecma10BinaryProperties, ecma11BinaryProperties, ecma12BinaryProperties, ecma13BinaryProperties, unicodeBinaryProperties, unicodeGeneralCategoryValues, ecma9ScriptValues, ecma10ScriptValues, ecma11ScriptValues, ecma12ScriptValues, ecma13ScriptValues, unicodeScriptValues, data, ecmaVersion, i, list, pp$1, RegExpValidationState, Token, pp, INVALID_TEMPLATE_ESCAPE_ERROR, version, pattern, GRAM_SIZE_LOWER, GRAM_SIZE_UPPER, non_word_regex, FuzzySet, void_element_names, parser_errors, WalkerBase, SyncWalker, id, re, get_comment_handlers, Scope$1, OPERATOR_PRECEDENCE, EXPRESSIONS_PRECEDENCE, has_newline, get_length, sum, join, scoped, deconflict, handle_body, handle_var_declaration, handlers, charToInteger, chars, i$1, btoa$1, sigils, join$1, flatten_body, flatten_properties, flatten$1, EMPTY, acorn_opts, inject, parse$1, parseExpressionAt$1, parse$2, parse_expression_at, whitespace, start_whitespace, end_whitespace, start_newline, dimensions, MIN_SIZE, SafeUint32Array, adoptBuffer, TYPE, NAME, _const, EOF, CATEGORY, i$2, charCodeDefinitions, isDigit$1, isHexDigit$2, isUppercaseLetter$1, isName$1, isWhiteSpace$1, isValidEscape$1, utils, TYPE$1, NAME$1, cmpStr$1, EOF$1, WHITESPACE, COMMENT, OFFSET_MASK, TYPE_SHIFT, TokenStream, TokenStream_1, TYPE$2, isNewline$1, isName$2, isValidEscape$2, isNumberStart$1, isIdentifierStart$2, charCodeCategory$1, isBOM$1, cmpStr$2, getNewlineLength$1, findWhiteSpaceEnd$1, consumeEscaped$1, consumeName$1, consumeNumber$1, consumeBadUrlRemnants$1, OFFSET_MASK$1, TYPE_SHIFT$1, tokenizer2, isBOM$2, N, F, R, OffsetToLocation, OffsetToLocation_1, createCustomError, MAX_LINE_LENGTH, OFFSET_CORRECTION, TAB_REPLACEMENT, SyntaxError$1, _SyntaxError, cursors, List, List_1, TYPE$3, WHITESPACE$1, COMMENT$1, sequence, findWhiteSpaceStart$1, cmpStr$3, noop, TYPE$4, NAME$2, WHITESPACE$2, COMMENT$2, IDENT, FUNCTION, URL$1, HASH, PERCENTAGE, NUMBER, NUMBERSIGN, NULL, create, cmpChar$1, cmpStr$4, TYPE$5, IDENT$1, STRING, NUMBER$1, FUNCTION$1, URL$2, HASH$1, DIMENSION, PERCENTAGE$1, LEFTPARENTHESIS, LEFTSQUAREBRACKET, COMMA, DELIM, NUMBERSIGN$1, ASTERISK, PLUSSIGN, HYPHENMINUS, SOLIDUS, U, _default, atrulePrelude, TYPE$6, DELIM$1, IDENT$2, DIMENSION$1, PERCENTAGE$2, NUMBER$2, HASH$2, COLON, LEFTSQUAREBRACKET$1, NUMBERSIGN$2, ASTERISK$1, PLUSSIGN$1, SOLIDUS$1, FULLSTOP, GREATERTHANSIGN, VERTICALLINE, TILDE, selector, expression, TYPE$7, WhiteSpace, Semicolon, LeftCurlyBracket, Delim, EXCLAMATIONMARK, Raw, TYPE$8, rawMode, COMMA$1, WHITESPACE$3, _var, value, scope, fontFace, TYPE$9, STRING$1, IDENT$3, URL$3, FUNCTION$2, LEFTPARENTHESIS$1, _import, media, page, TYPE$a, WHITESPACE$4, COMMENT$3, IDENT$4, FUNCTION$3, COLON$1, LEFTPARENTHESIS$2, supports, atrule, dir, has, lang, selectorList, matches, not, ALLOW_OF_CLAUSE, nthWithOfClause, nthChild, nthLastChild, DISALLOW_OF_CLAUSE, nth, nthLastOfType, nthOfType, slotted, pseudo, cmpChar$2, isDigit$2, TYPE$b, WHITESPACE$5, COMMENT$4, IDENT$5, NUMBER$3, DIMENSION$2, PLUSSIGN$2, HYPHENMINUS$1, N$1, DISALLOW_SIGN, ALLOW_SIGN, AnPlusB, TYPE$c, rawMode$1, ATKEYWORD, SEMICOLON, LEFTCURLYBRACKET, RIGHTCURLYBRACKET, Atrule, TYPE$d, SEMICOLON$1, LEFTCURLYBRACKET$1, AtrulePrelude, TYPE$e, IDENT$6, STRING$2, COLON$2, LEFTSQUAREBRACKET$2, RIGHTSQUAREBRACKET, DOLLARSIGN, ASTERISK$2, EQUALSSIGN, CIRCUMFLEXACCENT, VERTICALLINE$1, TILDE$1, AttributeSelector, TYPE$f, rawMode$2, WHITESPACE$6, COMMENT$5, SEMICOLON$2, ATKEYWORD$1, LEFTCURLYBRACKET$2, RIGHTCURLYBRACKET$1, Block, TYPE$g, LEFTSQUAREBRACKET$3, RIGHTSQUAREBRACKET$1, Brackets, CDC, CDC_1, CDO, CDO_1, TYPE$h, IDENT$7, FULLSTOP$1, ClassSelector, TYPE$i, IDENT$8, PLUSSIGN$3, SOLIDUS$2, GREATERTHANSIGN$1, TILDE$2, Combinator, TYPE$j, COMMENT$6, ASTERISK$3, SOLIDUS$3, Comment, hasOwnProperty$1, keywords$2, properties, HYPHENMINUS$2, names, isCustomProperty$1, TYPE$k, rawMode$3, IDENT$9, HASH$3, COLON$3, SEMICOLON$3, DELIM$2, WHITESPACE$7, EXCLAMATIONMARK$1, NUMBERSIGN$3, DOLLARSIGN$1, AMPERSAND, ASTERISK$4, PLUSSIGN$4, SOLIDUS$4, Declaration, TYPE$l, rawMode$4, WHITESPACE$8, COMMENT$7, SEMICOLON$4, DeclarationList, consumeNumber$2, TYPE$m, DIMENSION$3, Dimension, TYPE$n, RIGHTPARENTHESIS, _Function, TYPE$o, HASH$4, Hash, TYPE$p, IDENT$a, Identifier, TYPE$q, HASH$5, IdSelector, TYPE$r, IDENT$b, NUMBER$4, DIMENSION$4, LEFTPARENTHESIS$3, RIGHTPARENTHESIS$1, COLON$4, DELIM$3, MediaFeature, TYPE$s, WHITESPACE$9, COMMENT$8, IDENT$c, LEFTPARENTHESIS$4, MediaQuery, COMMA$2, MediaQueryList, Nth, NUMBER$5, _Number, Operator, TYPE$t, LEFTPARENTHESIS$5, RIGHTPARENTHESIS$2, Parentheses, consumeNumber$3, TYPE$u, PERCENTAGE$3, Percentage, TYPE$v, IDENT$d, FUNCTION$4, COLON$5, RIGHTPARENTHESIS$3, PseudoClassSelector, TYPE$w, IDENT$e, FUNCTION$5, COLON$6, RIGHTPARENTHESIS$4, PseudoElementSelector, isDigit$3, TYPE$x, NUMBER$6, DELIM$4, SOLIDUS$5, FULLSTOP$2, Ratio, TYPE$y, rawMode$5, LEFTCURLYBRACKET$3, Rule, Selector, TYPE$z, COMMA$3, SelectorList, STRING$3, _String, TYPE$A, WHITESPACE$a, COMMENT$9, ATKEYWORD$2, CDO$1, CDC$1, EXCLAMATIONMARK$2, StyleSheet, TYPE$B, IDENT$f, ASTERISK$5, VERTICALLINE$2, TypeSelector, isHexDigit$3, cmpChar$3, TYPE$C, NAME$3, IDENT$g, NUMBER$7, DIMENSION$5, PLUSSIGN$5, HYPHENMINUS$3, QUESTIONMARK, U$1, UnicodeRange, isWhiteSpace$2, cmpStr$5, TYPE$D, FUNCTION$6, URL$4, RIGHTPARENTHESIS$5, Url, Value, WHITESPACE$b, SPACE, WhiteSpace$1, node, parser, parser$1, entities, windows_1252, entity_pattern, NUL, disallowed_contents, valid_tag_name, meta_tags, valid_meta_tags, specials, SELF, COMPONENT, SLOT, ELEMENT, SQUARE_BRACKET_OPEN, SQUARE_BRACKET_CLOSE, CURLY_BRACKET_OPEN, CURLY_BRACKET_CLOSE, globals, reserved, CompileError, Parser$1, Block$1, Wrapper, Node$1, compiler_warnings, AbstractBlock, reserved_keywords, compiler_errors, Expression, allowed_parents, ConstTag, PendingBlock, CatchBlock, AwaitBlock, EventHandler, Action, Body, Comment$1, ElseBlock, EachBlock, escaped, Attribute, read_only_media_attributes, Binding, Transition, Animation, Class, StyleDirective, elements_without_text, Text, foreign, html, mathml, svg, xlink, xml, xmlns, valid_namespaces, namespaces, applicable, Let, svg$1, aria_attributes, aria_attribute_set, aria_roles, aria_role_set, a11y_required_attributes, a11y_distracting_elements, a11y_required_content, a11y_labelable, a11y_nested_implicit_semantics, a11y_implicit_semantics, invisible_elements, valid_modifiers, passive_events, react_attributes, attributes_to_compact_whitespace, Element, Head, IfBlock, InlineComponent, KeyBlock, Tag, MustacheTag, Options, RawMustacheTag, DebugTag, Slot, SlotTemplate, Title, valid_bindings, Window, ThenBlock, AwaitBlockBranch, AwaitBlockWrapper, TRUE, FALSE, EventHandlerWrapper, BodyWrapper, DebugTagWrapper, ElseBlockWrapper, EachBlockWrapper, TextWrapper, svg_attributes, svg_attribute_lookup, non_textlike_input_types, BaseAttributeWrapper, AttributeWrapper, attribute_lookup, boolean_attribute, StyleAttributeWrapper, SpreadAttributeWrapper, BindingWrapper, Tag$1, MustacheTagWrapper, RawMustacheTagWrapper, events, CHILD_DYNAMIC_ELEMENT_BLOCK, ElementWrapper, HeadWrapper, IfBlockBranch, IfBlockWrapper, KeyBlockWrapper, SlotTemplateWrapper, InlineComponentWrapper, SlotWrapper, TitleWrapper, associated_events, properties$1, readonly, WindowWrapper, wrappers, FragmentWrapper, Renderer, charToInteger$1, chars$1, i$3, OriginalSource, Url$1, parentRegex, FastStringArray, SourceMapTree, SourceMap, MappedCode, b64enc, b64dec, boolean_attributes, handlers$1, Renderer$1, wrappers$1, Chunk, btoa$2, SourceMap$1, toString$1, Mappings, n, warned, MagicString, UNKNOWN, BlockAppliesToNode, NodeExist, whitelist_attribute_selector, Selector$1, Block$2, is_keyframes_node, at_rule_has_declaration, Rule$1, Declaration$1, Atrule$1, get_default_css_hash, Stylesheet, test, TemplateScope, Fragment, internal_exports, Component, valid_options, PreprocessResult, VERSION;
var init_compiler = __esm({
  "node_modules/svelte/compiler.mjs"() {
    now = typeof process !== "undefined" && process.hrtime ? () => {
    ...
    SourceLocation = function SourceLocation2(p2, start, end) {
      this.start = start;
      this.end = end;
    ...
    Node = function Node2(parser2, pos, loc) {
      this.type = "";
      this.start = pos;
      this.end = 0;
    ...
    RegExpValidationState = function RegExpValidationState2(parser2) {
      this.parser = parser2;
    ...
    pattern = /^\s*svelte-ignore\s+([\s\S]+)\s*$/m;
    GRAM_SIZE_LOWER = 2;
    GRAM_SIZE_UPPER = 3;
    non_word_regex = /[^\w, ]+/;
    FuzzySet = class {
    ...
    id = Math.round(Math.random() * 1e20).toString(36);
    re = new RegExp(`_${id}_(?:(\\d+)|(AT)|(HASH))_(\\w+)?`, "g");
    get_comment_handlers = (comments, raw) => ({
...
${state.indent}`)
    ...
    handle_var_declaration = (node2, state) => {
...
${state.indent})`));
    ...
    flatten_properties = (array, target) => {
      for (let i = 0; i < array.length; i += 1) {
    ...
    inject = (raw, node2, values, comments) => {
    ...
    parseExpressionAt$1 = (source, index, opts) => {
      const comments = [];
      const { onComment, enter, leave } = get_comment_handlers(comments, source);
    ...
    parse$2 = (source) => parse$1(source, {
      sourceType: "module",
      ecmaVersion: 12,
      locations: true
    });
    parse_expression_at = (source, index) => parseExpressionAt$1(source, index, {
      sourceType: "module",
      ecmaVersion: 12,
      locations: true
    });
    ...
    MIN_SIZE = 16 * 1024;
    SafeUint32Array = typeof Uint32Array !== "undefined" ? Uint32Array : Array;
    ...
    isDigit$1 = charCodeDefinitions.isDigit;
    isHexDigit$2 = charCodeDefinitions.isHexDigit;
    isUppercaseLetter$1 = charCodeDefinitions.isUppercaseLetter;
    isName$1 = charCodeDefinitions.isName;
    isWhiteSpace$1 = charCodeDefinitions.isWhiteSpace;
    isValidEscape$1 = charCodeDefinitions.isValidEscape;
    utils = {
      consumeEscaped,
      consumeName,
      consumeNumber,
    ...
    TYPE$1 = _const.TYPE;
    NAME$1 = _const.NAME;
    cmpStr$1 = utils.cmpStr;
    EOF$1 = TYPE$1.EOF;
    WHITESPACE = TYPE$1.WhiteSpace;
    ...
    TYPE$2 = _const.TYPE;
    isNewline$1 = charCodeDefinitions.isNewline;
    isName$2 = charCodeDefinitions.isName;
    isValidEscape$2 = charCodeDefinitions.isValidEscape;
    isNumberStart$1 = charCodeDefinitions.isNumberStart;
    isIdentifierStart$2 = charCodeDefinitions.isIdentifierStart;
    charCodeCategory$1 = charCodeDefinitions.charCodeCategory;
    isBOM$1 = charCodeDefinitions.isBOM;
    cmpStr$2 = utils.cmpStr;
    getNewlineLength$1 = utils.getNewlineLength;
    findWhiteSpaceEnd$1 = utils.findWhiteSpaceEnd;
    consumeEscaped$1 = utils.consumeEscaped;
    consumeName$1 = utils.consumeName;
    consumeNumber$1 = utils.consumeNumber;
    consumeBadUrlRemnants$1 = utils.consumeBadUrlRemnants;
    OFFSET_MASK$1 = 16777215;
    TYPE_SHIFT$1 = 24;
    ...
    TAB_REPLACEMENT = "    ";
    SyntaxError$1 = function(message, source, offset2, line, column) {
    ...
    List_1 = List;
    TYPE$3 = tokenizer2.TYPE;
    WHITESPACE$1 = TYPE$3.WhiteSpace;
    COMMENT$1 = TYPE$3.Comment;
    ...
    ({ findWhiteSpaceStart: findWhiteSpaceStart$1, cmpStr: cmpStr$3 } = utils);
    noop = function() {
    };
    TYPE$4 = _const.TYPE;
    NAME$2 = _const.NAME;
    WHITESPACE$2 = TYPE$4.WhiteSpace;
    COMMENT$2 = TYPE$4.Comment;
    IDENT = TYPE$4.Ident;
    FUNCTION = TYPE$4.Function;
    URL$1 = TYPE$4.Url;
    HASH = TYPE$4.Hash;
    PERCENTAGE = TYPE$4.Percentage;
    NUMBER = TYPE$4.Number;
    NUMBERSIGN = 35;
    NULL = 0;
    create = function createParser(config) {
      var parser2 = {
    ...
    cmpChar$1 = tokenizer2.cmpChar;
    cmpStr$4 = tokenizer2.cmpStr;
    TYPE$5 = tokenizer2.TYPE;
    IDENT$1 = TYPE$5.Ident;
    STRING = TYPE$5.String;
    NUMBER$1 = TYPE$5.Number;
    FUNCTION$1 = TYPE$5.Function;
    URL$2 = TYPE$5.Url;
    HASH$1 = TYPE$5.Hash;
    DIMENSION = TYPE$5.Dimension;
    PERCENTAGE$1 = TYPE$5.Percentage;
    LEFTPARENTHESIS = TYPE$5.LeftParenthesis;
    LEFTSQUAREBRACKET = TYPE$5.LeftSquareBracket;
    COMMA = TYPE$5.Comma;
    DELIM = TYPE$5.Delim;
    NUMBERSIGN$1 = 35;
    ASTERISK = 42;
    ...
    TYPE$6 = tokenizer2.TYPE;
    DELIM$1 = TYPE$6.Delim;
    IDENT$2 = TYPE$6.Ident;
    DIMENSION$1 = TYPE$6.Dimension;
    PERCENTAGE$2 = TYPE$6.Percentage;
    NUMBER$2 = TYPE$6.Number;
    HASH$2 = TYPE$6.Hash;
    COLON = TYPE$6.Colon;
    LEFTSQUAREBRACKET$1 = TYPE$6.LeftSquareBracket;
    NUMBERSIGN$2 = 35;
    ASTERISK$1 = 42;
    PLUSSIGN$1 = 43;
    SOLIDUS$1 = 47;
    ...
    TYPE$7 = tokenizer2.TYPE;
    WhiteSpace = TYPE$7.WhiteSpace;
    Semicolon = TYPE$7.Semicolon;
    LeftCurlyBracket = TYPE$7.LeftCurlyBracket;
    Delim = TYPE$7.Delim;
    EXCLAMATIONMARK = 33;
    Raw = {
      name: "Raw",
    ...
    TYPE$8 = tokenizer2.TYPE;
    rawMode = Raw.mode;
    COMMA$1 = TYPE$8.Comma;
    WHITESPACE$3 = TYPE$8.WhiteSpace;
    _var = function() {
      var children = this.createList();
      this.scanner.skipSC();
    ...
    TYPE$9 = tokenizer2.TYPE;
    STRING$1 = TYPE$9.String;
    IDENT$3 = TYPE$9.Ident;
    URL$3 = TYPE$9.Url;
    FUNCTION$2 = TYPE$9.Function;
    LEFTPARENTHESIS$1 = TYPE$9.LeftParenthesis;
    _import = {
      parse: {
        prelude: function() {
          var children = this.createList();
    ...
    TYPE$a = tokenizer2.TYPE;
    WHITESPACE$4 = TYPE$a.WhiteSpace;
    COMMENT$3 = TYPE$a.Comment;
    IDENT$4 = TYPE$a.Ident;
    FUNCTION$3 = TYPE$a.Function;
    COLON$1 = TYPE$a.Colon;
    LEFTPARENTHESIS$2 = TYPE$a.LeftParenthesis;
    supports = {
      parse: {
        prelude: function() {
    ...
    nthChild = nthWithOfClause;
    nthLastChild = nthWithOfClause;
    DISALLOW_OF_CLAUSE = false;
    nth = {
      parse: function nth2() {
        return this.createSingleNodeList(
    ...
    cmpChar$2 = tokenizer2.cmpChar;
    isDigit$2 = tokenizer2.isDigit;
    TYPE$b = tokenizer2.TYPE;
    WHITESPACE$5 = TYPE$b.WhiteSpace;
    COMMENT$4 = TYPE$b.Comment;
    IDENT$5 = TYPE$b.Ident;
    NUMBER$3 = TYPE$b.Number;
    DIMENSION$2 = TYPE$b.Dimension;
    PLUSSIGN$2 = 43;
    HYPHENMINUS$1 = 45;
    N$1 = 110;
    DISALLOW_SIGN = true;
    ...
    TYPE$c = tokenizer2.TYPE;
    rawMode$1 = Raw.mode;
    ATKEYWORD = TYPE$c.AtKeyword;
    SEMICOLON = TYPE$c.Semicolon;
    LEFTCURLYBRACKET = TYPE$c.LeftCurlyBracket;
    RIGHTCURLYBRACKET = TYPE$c.RightCurlyBracket;
    Atrule = {
      name: "Atrule",
      structure: {
        name: String,
    ...
    TYPE$d = tokenizer2.TYPE;
    SEMICOLON$1 = TYPE$d.Semicolon;
    LEFTCURLYBRACKET$1 = TYPE$d.LeftCurlyBracket;
    AtrulePrelude = {
      name: "AtrulePrelude",
      structure: {
        children: [[]]
    ...
    TYPE$e = tokenizer2.TYPE;
    IDENT$6 = TYPE$e.Ident;
    STRING$2 = TYPE$e.String;
    COLON$2 = TYPE$e.Colon;
    LEFTSQUAREBRACKET$2 = TYPE$e.LeftSquareBracket;
    RIGHTSQUAREBRACKET = TYPE$e.RightSquareBracket;
    DOLLARSIGN = 36;
    ASTERISK$2 = 42;
    EQUALSSIGN = 61;
    CIRCUMFLEXACCENT = 94;
    ...
    TYPE$f = tokenizer2.TYPE;
    rawMode$2 = Raw.mode;
    WHITESPACE$6 = TYPE$f.WhiteSpace;
    COMMENT$5 = TYPE$f.Comment;
    SEMICOLON$2 = TYPE$f.Semicolon;
    ATKEYWORD$1 = TYPE$f.AtKeyword;
    LEFTCURLYBRACKET$2 = TYPE$f.LeftCurlyBracket;
    RIGHTCURLYBRACKET$1 = TYPE$f.RightCurlyBracket;
    Block = {
      name: "Block",
      structure: {
        children: [[
    ...
    TYPE$g = tokenizer2.TYPE;
    LEFTSQUAREBRACKET$3 = TYPE$g.LeftSquareBracket;
    RIGHTSQUAREBRACKET$1 = TYPE$g.RightSquareBracket;
    Brackets = {
      name: "Brackets",
      structure: {
        children: [[]]
    ...
    TYPE$h = tokenizer2.TYPE;
    IDENT$7 = TYPE$h.Ident;
    FULLSTOP$1 = 46;
    ClassSelector = {
      name: "ClassSelector",
      structure: {
    ...
    TYPE$i = tokenizer2.TYPE;
    IDENT$8 = TYPE$i.Ident;
    PLUSSIGN$3 = 43;
    SOLIDUS$2 = 47;
    ...
    TYPE$j = tokenizer2.TYPE;
    COMMENT$6 = TYPE$j.Comment;
    ASTERISK$3 = 42;
    SOLIDUS$3 = 47;
    Comment = {
      name: "Comment",
    ...
    keywords$2 = /* @__PURE__ */ Object.create(null);
    ...
    isCustomProperty$1 = names.isCustomProperty;
    TYPE$k = tokenizer2.TYPE;
    rawMode$3 = Raw.mode;
    IDENT$9 = TYPE$k.Ident;
    HASH$3 = TYPE$k.Hash;
    COLON$3 = TYPE$k.Colon;
    SEMICOLON$3 = TYPE$k.Semicolon;
    DELIM$2 = TYPE$k.Delim;
    WHITESPACE$7 = TYPE$k.WhiteSpace;
    ...
    TYPE$l = tokenizer2.TYPE;
    rawMode$4 = Raw.mode;
    WHITESPACE$8 = TYPE$l.WhiteSpace;
    COMMENT$7 = TYPE$l.Comment;
    SEMICOLON$4 = TYPE$l.Semicolon;
    DeclarationList = {
    ...
    consumeNumber$2 = utils.consumeNumber;
    TYPE$m = tokenizer2.TYPE;
    DIMENSION$3 = TYPE$m.Dimension;
    Dimension = {
      name: "Dimension",
      structure: {
        value: String,
    ...
    TYPE$n = tokenizer2.TYPE;
    RIGHTPARENTHESIS = TYPE$n.RightParenthesis;
    _Function = {
      name: "Function",
      structure: {
        name: String,
    ...
    TYPE$p = tokenizer2.TYPE;
    IDENT$a = TYPE$p.Ident;
    Identifier = {
      name: "Identifier",
      structure: {
        name: String
    ...
    TYPE$r = tokenizer2.TYPE;
    IDENT$b = TYPE$r.Ident;
    NUMBER$4 = TYPE$r.Number;
    DIMENSION$4 = TYPE$r.Dimension;
    LEFTPARENTHESIS$3 = TYPE$r.LeftParenthesis;
    RIGHTPARENTHESIS$1 = TYPE$r.RightParenthesis;
    COLON$4 = TYPE$r.Colon;
    DELIM$3 = TYPE$r.Delim;
    MediaFeature = {
      name: "MediaFeature",
      structure: {
        name: String,
    ...
    TYPE$s = tokenizer2.TYPE;
    WHITESPACE$9 = TYPE$s.WhiteSpace;
    COMMENT$8 = TYPE$s.Comment;
    IDENT$c = TYPE$s.Ident;
    LEFTPARENTHESIS$4 = TYPE$s.LeftParenthesis;
    MediaQuery = {
      name: "MediaQuery",
      structure: {
        children: [[
    ...
    NUMBER$5 = tokenizer2.TYPE.Number;
    _Number = {
      name: "Number",
      structure: {
        value: String
    ...
    TYPE$t = tokenizer2.TYPE;
    LEFTPARENTHESIS$5 = TYPE$t.LeftParenthesis;
    RIGHTPARENTHESIS$2 = TYPE$t.RightParenthesis;
    Parentheses = {
      name: "Parentheses",
      structure: {
        children: [[]]
    ...
    consumeNumber$3 = utils.consumeNumber;
    TYPE$u = tokenizer2.TYPE;
    PERCENTAGE$3 = TYPE$u.Percentage;
    Percentage = {
      name: "Percentage",
      structure: {
        value: String
    ...
    TYPE$v = tokenizer2.TYPE;
    IDENT$d = TYPE$v.Ident;
    FUNCTION$4 = TYPE$v.Function;
    COLON$5 = TYPE$v.Colon;
    RIGHTPARENTHESIS$3 = TYPE$v.RightParenthesis;
    PseudoClassSelector = {
    ...
    TYPE$w = tokenizer2.TYPE;
    IDENT$e = TYPE$w.Ident;
    FUNCTION$5 = TYPE$w.Function;
    COLON$6 = TYPE$w.Colon;
    RIGHTPARENTHESIS$4 = TYPE$w.RightParenthesis;
    ...
    isDigit$3 = tokenizer2.isDigit;
    TYPE$x = tokenizer2.TYPE;
    NUMBER$6 = TYPE$x.Number;
    DELIM$4 = TYPE$x.Delim;
    SOLIDUS$5 = 47;
    FULLSTOP$2 = 46;
    Ratio = {
      name: "Ratio",
    ...
    TYPE$y = tokenizer2.TYPE;
    rawMode$5 = Raw.mode;
    LEFTCURLYBRACKET$3 = TYPE$y.LeftCurlyBracket;
    Rule = {
      name: "Rule",
      structure: {
    ...
    TYPE$z = tokenizer2.TYPE;
    COMMA$3 = TYPE$z.Comma;
    SelectorList = {
      name: "SelectorList",
      structure: {
        children: [[
    ...
    STRING$3 = tokenizer2.TYPE.String;
    _String = {
      name: "String",
      structure: {
        value: String
    ...
    TYPE$A = tokenizer2.TYPE;
    WHITESPACE$a = TYPE$A.WhiteSpace;
    COMMENT$9 = TYPE$A.Comment;
    ATKEYWORD$2 = TYPE$A.AtKeyword;
    CDO$1 = TYPE$A.CDO;
    CDC$1 = TYPE$A.CDC;
    ...
    isHexDigit$3 = tokenizer2.isHexDigit;
    cmpChar$3 = tokenizer2.cmpChar;
    TYPE$C = tokenizer2.TYPE;
    NAME$3 = tokenizer2.NAME;
    IDENT$g = TYPE$C.Ident;
    NUMBER$7 = TYPE$C.Number;
    DIMENSION$5 = TYPE$C.Dimension;
    PLUSSIGN$5 = 43;
    HYPHENMINUS$3 = 45;
    QUESTIONMARK = 63;
    U$1 = 117;
    ...
    isWhiteSpace$2 = tokenizer2.isWhiteSpace;
    cmpStr$5 = tokenizer2.cmpStr;
    TYPE$D = tokenizer2.TYPE;
    FUNCTION$6 = TYPE$D.Function;
    URL$4 = TYPE$D.Url;
    RIGHTPARENTHESIS$5 = TYPE$D.RightParenthesis;
    Url = {
      name: "Url",
      structure: {
        value: ["String", "Raw"]
    ...
    WHITESPACE$b = tokenizer2.TYPE.WhiteSpace;
    SPACE = Object.freeze({
      type: "WhiteSpace",
      loc: null,
      value: " "
    ...
    entity_pattern = new RegExp(`&(#?(?:x[\\w\\d]+|\\d+|${Object.keys(entities).join("|")}))(?:;|\\b)`, "g");
    NUL = 0;
    disallowed_contents = /* @__PURE__ */ new Map([
    ...
    valid_tag_name = /^\!?[a-zA-Z]{1,}:?[a-zA-Z0-9\-]*/;
    meta_tags = /* @__PURE__ */ new Map([
      ["svelte:head", "Head"],
      ["svelte:options", "Options"],
      ["svelte:window", "Window"],
      ["svelte:body", "Body"]
    ]);
    valid_meta_tags = Array.from(meta_tags.keys()).concat("svelte:self", "svelte:component", "svelte:fragment", "svelte:element");
    ...
    SELF = /^svelte:self(?=[\s/>])/;
    COMPONENT = /^svelte:component(?=[\s/>])/;
    SLOT = /^svelte:fragment(?=[\s/>])/;
    ELEMENT = /^svelte:element(?=[\s/>])/;
    SQUARE_BRACKET_OPEN = "[".charCodeAt(0);
    SQUARE_BRACKET_CLOSE = "]".charCodeAt(0);
    CURLY_BRACKET_OPEN = "{".charCodeAt(0);
    CURLY_BRACKET_CLOSE = "}".charCodeAt(0);
...
${this.frame}`;
    ...
    AbstractBlock = class extends Node$1 {
    ...
    reserved_keywords = /* @__PURE__ */ new Set(["$$props", "$$restProps", "$$slots"]);
    compiler_errors = {
    ...
    allowed_parents = /* @__PURE__ */ new Set(["EachBlock", "CatchBlock", "ThenBlock", "InlineComponent", "SlotTemplate", "IfBlock", "ElseBlock"]);
    ConstTag = class extends Node$1 {
      constructor(component, parent, scope2, info) {
        super(component, parent, scope2, info);
        this.contexts = [];
    ...
    PendingBlock = class extends AbstractBlock {
      constructor(component, parent, scope2, info) {
        super(component, parent, scope2, info);
    ...
    CatchBlock = class extends AbstractBlock {
      constructor(component, parent, scope2, info) {
        super(component, parent, scope2, info);
    ...
    AwaitBlock = class extends Node$1 {
      constructor(component, parent, scope2, info) {
        super(component, parent, scope2, info);
    ...
    EventHandler = class extends Node$1 {
    ...
    Comment$1 = class extends Node$1 {
      constructor(component, parent, scope2, info) {
        super(component, parent, scope2, info);
        this.data = info.data;
    ...
    ElseBlock = class extends AbstractBlock {
      constructor(component, parent, scope2, info) {
        super(component, parent, scope2, info);
        this.scope = scope2.child();
    ...
    EachBlock = class extends AbstractBlock {
      constructor(component, parent, scope2, info) {
        super(component, parent, scope2, info);
    ...
    Attribute = class extends Node$1 {
      constructor(component, parent, scope2, info) {
        super(component, parent, scope2, info);
        this.scope = scope2;
        if (info.type === "Spread") {
    ...
    read_only_media_attributes = /* @__PURE__ */ new Set([
      "duration",
      "buffered",
      "seekable",
      "played",
    ...
    Transition = class extends Node$1 {
      constructor(component, parent, scope2, info) {
        super(component, parent, scope2, info);
    ...
    Animation = class extends Node$1 {
      constructor(component, parent, scope2, info) {
        super(component, parent, scope2, info);
        component.warn_if_undefined(info.name, info, scope2);
        this.name = info.name;
    ...
    StyleDirective = class extends Node$1 {
      constructor(component, parent, scope2, info) {
        super(component, parent, scope2, info);
        this.name = info.name;
    ...
    elements_without_text = /* @__PURE__ */ new Set([
      "audio",
      "datalist",
      "dl",
      "optgroup",
    ...
    foreign = "https://svelte.dev/docs#template-syntax-svelte-options";
    ...
    namespaces = { foreign, html, mathml, svg, xlink, xml, xmlns };
    applicable = /* @__PURE__ */ new Set(["Identifier", "ObjectExpression", "ArrayExpression", "Property"]);
    Let = class extends Node$1 {
      constructor(component, parent, scope2, info) {
        super(component, parent, scope2, info);
        this.names = [];
    ...
    svg$1 = /^(?:altGlyph|altGlyphDef|altGlyphItem|animate|animateColor|animateMotion|animateTransform|circle|clipPath|color-profile|cursor|defs|desc|discard|ellipse|feBlend|feColorMatrix|feComponentTransfer|feComposite|feConvolveMatrix|feDiffuseLighting|feDisplacementMap|feDistantLight|feDropShadow|feFlood|feFuncA|feFuncB|feFuncG|feFuncR|feGaussianBlur|feImage|feMerge|feMergeNode|feMorphology|feOffset|fePointLight|feSpecularLighting|feSpotLight|feTile|feTurbulence|filter|font|font-face|font-face-format|font-face-name|font-face-src|font-face-uri|foreignObject|g|glyph|glyphRef|hatch|hatchpath|hkern|image|line|linearGradient|marker|mask|mesh|meshgradient|meshpatch|meshrow|metadata|missing-glyph|mpath|path|pattern|polygon|polyline|radialGradient|rect|set|solidcolor|stop|svg|switch|symbol|text|textPath|tref|tspan|unknown|use|view|vkern)$/;
    aria_attributes = "activedescendant atomic autocomplete busy checked colcount colindex colspan controls current describedby description details disabled dropeffect errormessage expanded flowto grabbed haspopup hidden invalid keyshortcuts label labelledby level live modal multiline multiselectable orientation owns placeholder posinset pressed readonly relevant required roledescription rowcount rowindex rowspan selected setsize sort valuemax valuemin valuenow valuetext".split(" ");
    aria_attribute_set = new Set(aria_attributes);
    ...
    aria_role_set = new Set(aria_roles);
    ...
    a11y_distracting_elements = /* @__PURE__ */ new Set([
      "blink",
      "marquee"
    ]);
    a11y_required_content = /* @__PURE__ */ new Set([
      "a",
      "h1",
      "h2",
      "h3",
    ...
    a11y_labelable = /* @__PURE__ */ new Set([
      "button",
      "input",
      "keygen",
      "meter",
    ...
    a11y_nested_implicit_semantics = /* @__PURE__ */ new Map([
      ["header", "banner"],
      ["footer", "contentinfo"]
    ]);
    a11y_implicit_semantics = /* @__PURE__ */ new Map([
      ["a", "link"],
      ["aside", "complementary"],
      ["body", "document"],
      ["datalist", "listbox"],
    ...
    invisible_elements = /* @__PURE__ */ new Set(["meta", "html", "script", "style"]);
    valid_modifiers = /* @__PURE__ */ new Set([
      "preventDefault",
      "stopPropagation",
      "capture",
      "once",
    ...
    react_attributes = /* @__PURE__ */ new Map([
      ["className", "class"],
      ["htmlFor", "for"]
    ]);
    attributes_to_compact_whitespace = ["class", "style"];
    Element = class extends Node$1 {
      constructor(component, parent, scope2, info) {
        super(component, parent, scope2, info);
        this.attributes = [];
        this.actions = [];
        ...
        this.handlers.forEach((handler) => {
          ...
          handler.modifiers.forEach((modifier) => {
            if (!valid_modifiers.has(modifier)) {
              return component.error(handler, compiler_errors.invalid_event_modifier(list$1(Array.from(valid_modifiers))));
            }
            if (modifier === "passive") {
    ...
    IfBlock = class extends AbstractBlock {
      constructor(component, parent, scope2, info) {
        super(component, parent, scope2, info);
        this.scope = scope2.child();
    ...
    InlineComponent = class extends Node$1 {
      constructor(component, parent, scope2, info) {
        super(component, parent, scope2, info);
        this.attributes = [];
        this.bindings = [];
    ...
    KeyBlock = class extends AbstractBlock {
      constructor(component, parent, scope2, info) {
        super(component, parent, scope2, info);
        this.expression = new Expression(component, this, scope2, info.expression);
    ...
    MustacheTag = class extends Tag {
    };
    Options = class extends Node$1 {
    };
    RawMustacheTag = class extends Tag {
    };
    DebugTag = class extends Node$1 {
      constructor(component, parent, scope2, info) {
        super(component, parent, scope2, info);
    ...
    SlotTemplate = class extends Node$1 {
      constructor(component, parent, scope2, info) {
        super(component, parent, scope2, info);
        this.lets = [];
    ...
    ThenBlock = class extends AbstractBlock {
      constructor(component, parent, scope2, info) {
        super(component, parent, scope2, info);
        this.scope = scope2.child();
        if (parent.then_node) {
    ...
    AwaitBlockBranch = class extends Wrapper {
    ...
    AwaitBlockWrapper = class extends Wrapper {
    ...
    BodyWrapper = class extends Wrapper {
      constructor(renderer, block, parent, node2) {
        super(renderer, block, parent, node2);
    ...
    DebugTagWrapper = class extends Wrapper {
    ...
    ElseBlockWrapper = class extends Wrapper {
      constructor(renderer, block, parent, node2, strip_whitespace, next_sibling) {
        super(renderer, block, parent, node2);
        this.var = null;
    ...
    EachBlockWrapper = class extends Wrapper {
      constructor(renderer, block, parent, node2, strip_whitespace, next_sibling) {
        super(renderer, block, parent, node2);
        this.updates = [];
    ...
    TextWrapper = class extends Wrapper {
    ...
    svg_attributes = "accent-height accumulate additive alignment-baseline allowReorder alphabetic amplitude arabic-form ascent attributeName attributeType autoReverse azimuth baseFrequency baseline-shift baseProfile bbox begin bias by calcMode cap-height class clip clipPathUnits clip-path clip-rule color color-interpolation color-interpolation-filters color-profile color-rendering contentScriptType contentStyleType cursor cx cy d decelerate descent diffuseConstant direction display divisor dominant-baseline dur dx dy edgeMode elevation enable-background end exponent externalResourcesRequired fill fill-opacity fill-rule filter filterRes filterUnits flood-color flood-opacity font-family font-size font-size-adjust font-stretch font-style font-variant font-weight format from fr fx fy g1 g2 glyph-name glyph-orientation-horizontal glyph-orientation-vertical glyphRef gradientTransform gradientUnits hanging height href horiz-adv-x horiz-origin-x id ideographic image-rendering in in2 intercept k k1 k2 k3 k4 kernelMatrix kernelUnitLength kerning keyPoints keySplines keyTimes lang lengthAdjust letter-spacing lighting-color limitingConeAngle local marker-end marker-mid marker-start markerHeight markerUnits markerWidth mask maskContentUnits maskUnits mathematical max media method min mode name numOctaves offset onabort onactivate onbegin onclick onend onerror onfocusin onfocusout onload onmousedown onmousemove onmouseout onmouseover onmouseup onrepeat onresize onscroll onunload opacity operator order orient orientation origin overflow overline-position overline-thickness panose-1 paint-order pathLength patternContentUnits patternTransform patternUnits pointer-events points pointsAtX pointsAtY pointsAtZ preserveAlpha preserveAspectRatio primitiveUnits r radius refX refY rendering-intent repeatCount repeatDur requiredExtensions requiredFeatures restart result rotate rx ry scale seed shape-rendering slope spacing specularConstant specularExponent speed spreadMethod startOffset stdDeviation stemh stemv stitchTiles stop-color stop-opacity strikethrough-position strikethrough-thickness string stroke stroke-dasharray stroke-dashoffset stroke-linecap stroke-linejoin stroke-miterlimit stroke-opacity stroke-width style surfaceScale systemLanguage tabindex tableValues target targetX targetY text-anchor text-decoration text-rendering textLength to transform type u1 u2 underline-position underline-thickness unicode unicode-bidi unicode-range units-per-em v-alphabetic v-hanging v-ideographic v-mathematical values version vert-adv-y vert-origin-x vert-origin-y viewBox viewTarget visibility width widths word-spacing writing-mode x x-height x1 x2 xChannelSelector xlink:actuate xlink:arcrole xlink:href xlink:role xlink:show xlink:title xlink:type xml:base xml:lang xml:space y y1 y2 yChannelSelector z zoomAndPan".split(" ");
    svg_attribute_lookup = /* @__PURE__ */ new Map();
    svg_attributes.forEach((name) => {
      svg_attribute_lookup.set(name.toLowerCase(), name);
    });
    non_textlike_input_types = /* @__PURE__ */ new Set([
      "button",
      "checkbox",
      "color",
      "date",
    ...
    AttributeWrapper = class extends BaseAttributeWrapper {
      constructor(parent, block, node2) {
    ...
    boolean_attribute = /* @__PURE__ */ new Set([
      "allowfullscreen",
      "allowpaymentrequest",
      "async",
      "autofocus",
    ...
    StyleAttributeWrapper = class extends AttributeWrapper {
      render(block) {
    ...
    SpreadAttributeWrapper = class extends BaseAttributeWrapper {
    };
    ...
    MustacheTagWrapper = class extends Tag$1 {
      constructor(renderer, block, parent, node2) {
        super(renderer, block, parent, node2);
    ...
    RawMustacheTagWrapper = class extends Tag$1 {
      constructor(renderer, block, parent, node2) {
        super(renderer, block, parent, node2);
    ...
    CHILD_DYNAMIC_ELEMENT_BLOCK = "child_dynamic_element";
    ElementWrapper = class extends Wrapper {
      constructor(renderer, block, parent, node2, strip_whitespace, next_sibling) {
        super(renderer, block, parent, node2);
    ...
    HeadWrapper = class extends Wrapper {
      constructor(renderer, block, parent, node2, strip_whitespace, next_sibling) {
        super(renderer, block, parent, node2);
        this.can_use_innerhtml = false;
        this.fragment = new FragmentWrapper(renderer, block, node2.children, this, strip_whitespace, next_sibling);
    ...
    IfBlockBranch = class extends Wrapper {
      constructor(renderer, block, parent, node2, strip_whitespace, next_sibling) {
        super(renderer, block, parent, node2);
        this.var = null;
    ...
    IfBlockWrapper = class extends Wrapper {
      constructor(renderer, block, parent, node2, strip_whitespace, next_sibling) {
        super(renderer, block, parent, node2);
    ...
    KeyBlockWrapper = class extends Wrapper {
      constructor(renderer, block, parent, node2, strip_whitespace, next_sibling) {
        super(renderer, block, parent, node2);
    ...
    SlotTemplateWrapper = class extends Wrapper {
      constructor(renderer, block, parent, node2, strip_whitespace, next_sibling) {
        super(renderer, block, parent, node2);
    ...
    InlineComponentWrapper = class extends Wrapper {
      constructor(renderer, block, parent, node2, strip_whitespace, next_sibling) {
        super(renderer, block, parent, node2);
    ...
    SlotWrapper = class extends Wrapper {
      constructor(renderer, block, parent, node2, strip_whitespace, next_sibling) {
        super(renderer, block, parent, node2);
        this.fallback = null;
    ...
    TitleWrapper = class extends Wrapper {
      constructor(renderer, block, parent, node2, _strip_whitespace, _next_sibling) {
        super(renderer, block, parent, node2);
      }
      render(block, _parent_node, _parent_nodes) {
    ...
    WindowWrapper = class extends Wrapper {
      constructor(renderer, block, parent, node2) {
        super(renderer, block, parent, node2);
        this.handlers = this.node.handlers.map((handler) => new EventHandlerWrapper(handler, this));
      }
    ...
    Url$1 = typeof URL !== "undefined" ? URL : require_url().URL;
    parentRegex = /(^|\/)\.\.(?=\/|$)/g;
    FastStringArray = class {
      constructor() {
    ...
    b64enc = typeof btoa == "function" ? btoa : (b2) => Buffer.from(b2).toString("base64");
    b64dec = typeof atob == "function" ? atob : (a) => Buffer.from(a, "base64").toString();
    ...
    SourceMap$1 = function SourceMap2(properties2) {
      this.version = 3;
    ...
    whitelist_attribute_selector = /* @__PURE__ */ new Map([
    ...
    is_keyframes_node = (node2) => remove_css_prefix(node2.name) === "keyframes";
    at_rule_has_declaration = ({ block }) => block && block.children && block.children.find((node2) => node2.type === "Declaration");
    Rule$1 = class {
    ...
    get_default_css_hash = ({ css, hash: hash2 }) => {
    ...
    test = typeof process !== "undefined" && process.env.TEST;
    TemplateScope = class {
      constructor(parent) {
    ...
    Component = class {
      ...
      generate(result) {
        ...
        if (result) {
          ...
          const banner = `${this.file ? `${this.file} ` : ""}generated by Svelte v${"3.49.0"}`;
...
var require_rollup_plugin_svelte = __commonJS({
  "node_modules/rollup-plugin-svelte/index.js"(exports, module) {
    var path = require_path();
    var relative = require_require_relative();
    var { createFilter } = (init_pluginutils_es(), __toCommonJS(pluginutils_es_exports));
    var { compile: compile2, preprocess: preprocess2 } = (init_compiler(), __toCommonJS(compiler_exports));
    var PREFIX = "[rollup-plugin-svelte]";
    var pkg_export_errors = /* @__PURE__ */ new Set();
    var plugin_options = /* @__PURE__ */ new Set([
      "emitCss",
      "exclude",
      "extensions",
      "include",
      ...
      return {
        ...
        resolveId(importee, importer) {
          ...
          try {
            ...
            dir2 = path.dirname(resolved);
            pkg = __require(resolved);
          } catch (err) {
          ...
          if (parts.length === 0 && pkg.svelte) {
            return path.resolve(dir2, pkg.svelte);
          }
        },
        load(id2) {
          return cache_emit.get(id2) || null;
        },
        async transform(code, id2) {
          if (!filter(id2))
            return null;
          const extension = path.extname(id2);
          if (!~extensions.indexOf(extension))
            return null;
          const dependencies = [];
          const filename = path.relative(process.cwd(), id2);
          const svelte_options = { ...compilerOptions, filename };
          if (rest.preprocess) {
            const processed = await preprocess2(code, rest.preprocess, { filename });
            if (processed.dependencies)
              dependencies.push(...processed.dependencies);
            if (processed.map)
          ...
          const compiled = compile2(code, svelte_options);
          ...
          if (emitCss && compiled.css.code) {
            const fname = id2.replace(new RegExp(`\\${extension}$`), ".css");
            compiled.js.code += `
...
// dep:@typhonjs-fvtt_runtime___rollup-plugin-svelte
var typhonjs_fvtt_runtime_rollup_plugin_svelte_default = require_rollup_plugin_svelte();
export {
  typhonjs_fvtt_runtime_rollup_plugin_svelte_default as default
};
//# sourceMappingURL=@typhonjs-fvtt_runtime___rollup-plugin-svelte.js.map
