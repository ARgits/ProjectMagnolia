...
var import_path, import_util, addExtension, extractors, extractAssignedNames, blockDeclarations, Scope, attachScopes,
    utils, utils_1, utils_2, utils_3, utils_4, utils_5, utils_6, utils_7, utils_8, utils_9, stringify, isNumber,
    toRegexRange, toRegexRange_1, isObject, transform, isValidValue, isNumber$1, zeros, stringify$1, pad, toMaxLen,
    toSequence, toRange, toRegex, rangeError, invalidRange, invalidStep, fillNumbers, fillLetters, fill, fillRange,
    compile, compile_1, append, expand, expand_1, constants, MAX_LENGTH, CHAR_BACKSLASH, CHAR_BACKTICK, CHAR_COMMA,
    CHAR_DOT, CHAR_LEFT_PARENTHESES, CHAR_RIGHT_PARENTHESES, CHAR_LEFT_CURLY_BRACE, CHAR_RIGHT_CURLY_BRACE,
    CHAR_LEFT_SQUARE_BRACKET, CHAR_RIGHT_SQUARE_BRACKET, CHAR_DOUBLE_QUOTE, CHAR_SINGLE_QUOTE, CHAR_NO_BREAK_SPACE,
    CHAR_ZERO_WIDTH_NOBREAK_SPACE, parse, parse_1, braces, braces_1, WIN_SLASH, WIN_NO_SLASH, DOT_LITERAL, PLUS_LITERAL,
    QMARK_LITERAL, SLASH_LITERAL, ONE_CHAR, QMARK, END_ANCHOR, START_ANCHOR, DOTS_SLASH, NO_DOT, NO_DOTS, NO_DOT_SLASH,
    NO_DOTS_SLASH, QMARK_NO_DOT, STAR, POSIX_CHARS, WINDOWS_CHARS, POSIX_REGEX_SOURCE, constants$1, utils$1, utils_1$1,
    utils_2$1, utils_3$1, utils_4$1, utils_5$1, utils_6$1, utils_7$1, utils_8$1, utils_9$1, CHAR_ASTERISK, CHAR_AT,
    CHAR_BACKWARD_SLASH, CHAR_COMMA$1, CHAR_DOT$1, CHAR_EXCLAMATION_MARK, CHAR_FORWARD_SLASH, CHAR_LEFT_CURLY_BRACE$1,
    CHAR_LEFT_PARENTHESES$1, CHAR_LEFT_SQUARE_BRACKET$1, CHAR_PLUS, CHAR_QUESTION_MARK, CHAR_RIGHT_CURLY_BRACE$1,
    CHAR_RIGHT_PARENTHESES$1, CHAR_RIGHT_SQUARE_BRACKET$1, isPathSeparator, scan, MAX_LENGTH$1, POSIX_REGEX_SOURCE$1,
    REGEX_NON_SPECIAL_CHAR, REGEX_SPECIAL_CHARS_BACKREF, REPLACEMENTS, expandRange, negate, syntaxError, parse$1,
    parse_1$1, picomatch, picomatch_1, picomatch$1, isEmptyString, micromatch, micromatch_1, createFilter,
    reservedWords, builtins, forbiddenIdentifiers, makeLegalIdentifier, dataToEsm;
var init_pluginutils_es = __esm({
    "node_modules/rollup-pluginutils/dist/pluginutils.es.js"() {
        ...
        WINDOWS_CHARS = Object.assign({}, POSIX_CHARS, {
