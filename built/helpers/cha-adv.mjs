...
var CharacterAdvancement = /** @class */ (function (_super) {
    ...
    CharacterAdvancement.prototype.getData = function (options) {
            ...
            return __generator(this, function (_25) {
                switch (_25.label) {
                    ...
                    case 4:
                        ...
                        this_1 = this;
                        for (_v = 0, _w = Object.entries(temp_feat_list); _v < _w.length; _v++) {
                        ...
                        for (_y = 0, _z = Object.entries(CONFIG.ARd20.skills); _y < _z.length; _y++) {
                        ...
                        for (_1 = 0, _2 = Object.entries(this.data.feats.learned); _1 < _2.length; _1++) {
                    ...
                    case 5:
                         ...
                         */
                        for (_4 = 0, _5 = Object.entries(CONFIG.ARd20.abilities); _4 < _5.length; _4++) {
                         ...
                         */
                        for (_7 = 0, _8 = Object.entries(CONFIG.ARd20.skills); _7 < _8.length; _7++) {
                            _9 = _8[_7], k = _9[0], v = _9[1];
                            this.data.skills[k].rank_name = (_j = game.i18n.localize(CONFIG.ARd20.prof[this.data.skills[k].rank])) !== null && _j !== void 0 ? _j : this.data.skills[k].rank;
                        ...
                        for (_10 = 0, _11 = Object.entries(this.data.profs.weapon); _10 < _11.length; _10++) {
                            _12 = _11[_10], k = _12[0], v = _12[1];
                            v.value_hover = (_k = game.i18n.localize(CONFIG.ARd20.prof[v.value])) !== null && _k !== void 0 ? _k : CONFIG.ARd20.prof[v.value];
                        }
                        _loop_4 = function (k, object) {
                            ...
                            var _loop_5 = function (key, r) {
                                switch (r.type) {
                                    case "ability": //check if character's ability is equal or higher than value entered in feature requirements
                                        r.pass.forEach(function (item, index) { return (r.pass[index] = r.input[index] <= _this.data.abilities[r.value].final); });
                                        break;
                            ...
                            for (var _29 = 0, _30 = Object.entries(object.data.req.values); _29 < _30.length; _29++) {
                         ...
                         */
                        for (_13 = 0, _14 = Object.entries(this.data.feats.awail); _13 < _14.length; _13++) {
                         ...
                         */
                        for (_16 = 0, _17 = Object.entries(this.data.races.list); _16 < _17.length; _16++) {
                            _18 = _17[_16], key = _18[0], race = _18[1];
                            dieNumber = Math.ceil(Math.max(this.data.abilities.con.value + race.data.bonus.abil.con.value - 7, 0) / 4);
                            firstDie = CONFIG.ARd20.HPdice.slice(CONFIG.ARd20.HPdice.indexOf(race.data.FhpDie));
                            race_mod = Math.floor((this.data.abilities.con.value + race.data.bonus.abil.con.value - 10) / 2);
                        ...
                        if (!this.object.data.isReady) {
                            abil_sum = null;
                            for (_19 = 0, _20 = Object.entries(this.data.abilities); _19 < _20.length; _19++) {
                            ...
                            allow_list = [];
                            for (_22 = 0, _23 = Object.entries(this.data.allow); _22 < _23.length; _22++) {
        ...
        switch (button.dataset.type) {
            case "ability":
                switch (button.dataset.action) {
                    ...
                    case "minus":
                        data.abilities[button.dataset.key].value -= 1;
                        data.xp.get += (_a = CONFIG.ARd20.abil_xp[data.abilities[button.dataset.key].value - 5]) !== null && _a !== void 0 ? _a : CONFIG.ARd20.abil_xp[data.abilities[button.dataset.key].value - 5];
                        data.xp.used -= (_b = CONFIG.ARd20.abil_xp[data.abilities[button.dataset.key].value - 5]) !== null && _b !== void 0 ? _b : CONFIG.ARd20.abil_xp[data.abilities[button.dataset.key].value - 5];
                        break;
                }
                break;
            case "skill":
    ...
    CharacterAdvancement.prototype._onChangeInput = function (event) {
        ...
        for (var _i = 0, _a = Object.entries(this.data.races.list); _i < _a.length; _i++) {
            ...
            return __generator(this, function (_q) {
                switch (_q.label) {
                    case 0:
                        ...
                        this.render();
                        obj = {};
                        for (_i = 0, _a = Object.entries(this.data.abilities); _i < _a.length; _i++) {
                            _b = _a[_i], key = _b[0], abil = _b[1];
                            obj["data.abilities.".concat(key, ".value")] = this.data.abilities[key].final;
                        }
                        ...
                        for (_c = 0, _d = Object.entries(feats); _c < _d.length; _c++) {
                            ...
                            if (this.data.feats.learned.length > 0) {
                                for (_f = 0, _g = Object.entries(this.data.feats.learned); _f < _g.length; _f++) {
                        ...
                        pass = [];
                        for (_j = 0, _k = Object.entries(feats_data.exist); _j < _k.length; _j++) {
                    ...
                    case 1:
                        ...
                        return [3 /*break*/, 10];
                    case 2: return [4 /*yield*/, actor.update(obj)];
                    case 3:
                        _q.sent();
