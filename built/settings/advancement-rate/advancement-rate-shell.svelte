...
<ApplicationShell bind:elementRoot>
    ...
    <section>
      <div>
        ...
        <input type="text" bind:value={advancementSetting.formulas.attributes} />
      </div>
      <br />
      <div>
        <label for="Skill Formula">Skill Advancement Formula</label>
        <input type="text" bind:value={advancementSetting.formulas.skills} />
      </div>
      <br />
      <div>
        <label for="Feature Formula">Feature Advancement Formula</label>
        <input type="text" bind:value={advancementSetting.formulas.features} />
      </div>
    </section>
