...
var effects_js_1 = require("../helpers/effects.js");
var cha_adv_js_1 = require("../helpers/cha-adv.js");
var ard20_js_1 = require("../ard20.js");
var constants_mjs_1 = require("@league-of-foundry-developers/foundry-vtt-types/src/foundry/common/constants.mjs");
/**
...
var ARd20ActorSheet = /** @class */ (function (_super) {
    ...
    ARd20ActorSheet.prototype.getData = function () {
        ...
        //@ts-expect-error
        context.effects = (0, effects_js_1.prepareActiveEffectCategories)(this.actor.effects);
        return context;
    };
    /**
    ...
    ARd20ActorSheet.prototype._prepareCharacterData = function (context) {
        ...
        for (var _i = 0, _d = (0, ard20_js_1.obj_entries)(context.data.attributes); _i < _d.length; _i++) {
            var _e = _d[_i], k = _e[0], v = _e[1];
            //@ts-expect-error
            v.label = (_a = game.i18n.localize((0, ard20_js_1.getValues)(CONFIG.ARd20.Attributes, k))) !== null && _a !== void 0 ? _a : k;
        }
        for (var _f = 0, _g = (0, ard20_js_1.obj_entries)(context.data.skills); _f < _g.length; _f++) {
            var _h = _g[_f], k = _h[0], v = _h[1];
            //@ts-expect-error
            v.name = (_b = game.i18n.localize((0, ard20_js_1.getValues)(CONFIG.ARd20.Skills, k))) !== null && _b !== void 0 ? _b : k;
            v.rank_name = (_c = game.i18n.localize((0, ard20_js_1.getValues)(CONFIG.ARd20.Rank, v.rank))) !== null && _c !== void 0 ? _c : v.rank;
        }
    };
    /**
     * Organize and classify Items for Character sheets.
    ...
    ARd20ActorSheet.prototype._prepareItems = function (context) {
        ...
        for (var _i = 0, _a = context.items; _i < _a.length; _i++) {
            var i = _a[_i];
            i.img = i.img || constants_mjs_1.DEFAULT_TOKEN;
            // Append to gear.
            if (i.type === "item") {
                gear.push(i);
            }
    ...
    ARd20ActorSheet.prototype.activateListeners = function (html) {
        ...
        html.find(".effect-control").click(function (ev) { return (0, effects_js_1.onManageActiveEffect)(ev, _this.actor); });
    ...
    ARd20ActorSheet.prototype._OnAdvanceMenu = function (event) {
        ...
        var app;
        //@ts-ignore
        switch ((_a = button.dataset) === null || _a === void 0 ? void 0 : _a.action) {
            case "adv":
                app = new cha_adv_js_1.CharacterAdvancement(this.object);
                break;
        }
    ...
    ARd20ActorSheet.prototype._onItemRoll = function (event) {
        ...
        var hasAttack = item.data.data.hasAttack;
        var hasDamage = item.data.data.hasDamage;
        //@ts-expect-error
        if (item)
