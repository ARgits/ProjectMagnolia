...
var feat_req_js_1 = require("../helpers/feat_req.js");
/**
...
var ARd20ItemSheet = /** @class */ (function (_super) {
    ...
    ARd20ItemSheet.prototype.getData = function () {
        ...
        //@ts-expect-error
        context.effects = (0, effects_js_1.prepareActiveEffectCategories)(this.item.effects);
        return context;
    };
    ARd20ItemSheet.prototype._getSubmitData = function (updateData) {
        ...
        if (damage) {
            if (damage.parts) {
                ...
                for (var _i = 0, _b = (0, ard20_js_1.obj_entries)(damage); _i < _b.length; _i++) {
                    ...
                    for (var _d = 0, _e = (0, ard20_js_1.obj_entries)(type); _d < _e.length; _d++) {
    ...
    ARd20ItemSheet.prototype.activateListeners = function (html) {
        ...
        if (!this.isEditable)
            return;
        //@ts-expect-error
        html.find(".effect-control").click(function (ev) { return (0, effects_js_1.onManageActiveEffect)(ev, _this.item); });
    ...
    ARd20ItemSheet.prototype._FeatReq = function (event) {
        ...
        switch (button.dataset.action) {
            case "feat-req":
                app = new feat_req_js_1.FeatRequirements(this.object);
                break;
        }
