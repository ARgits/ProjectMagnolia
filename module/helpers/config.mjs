...
ARd20.source = [
  { id: "mar", text: "ARd20.Martial" },
  { id: "mag", text: "ARd20.Magical" },
  { id: "div", text: "ARd20.Divine" },
  { id: "pri", text: "ARd20.Primal" },
  { id: "psy", text: "ARd20.Psyhic" },
];
ARd20.Prop = {
  aff: "ARd20.Affixed",
  awk: "ARd20.Awkward",
...
ARd20.abil_xp = [50, 50, 50, 50, 70, 90, 120, 150, 190, 290, 440, 660, 990, 1500, 2700, 4800, 8400, 14700, 25700, 51500, 103000, 206000, 412000, 824000, 2060000];
ARd20.skill_xp = {
