import { ItemDataBaseProperties, ItemDataSource } from "@league-of-foundry-developers/foundry-vtt-types/src/foundry/common/data/data.mjs/itemData";
...
export class CharacterAdvancement extends FormApplication<CharacterAdvancementFormAppOptions, CharacterAdvancementFormAppData, CharacterAdvancementFormObject> {
  ...
  async getData(): Promise<CharacterAdvancementFormAppData> {
    ...
    templateData.count.feats.all = Object.values(templateData.count.feats).reduce(function (a: number, b: number) {
      return a + b;
    }, 0);
    /*
...
function arr_keys(temp_feat_list: ItemDataSource[]) {
